...
check_point = inspector.checker(inspect_parameter[0].first, inspect_parameter[0].last)
check_point.empty? ? indicator.push(1) : show_output(check_point, 'curly brace(s)')
# To indentify missing or unexpected bracket(s)
check_point = inspector.checker(inspect_parameter[1].first, inspect_parameter[1].last)
check_point.empty? ? indicator.push(1) : show_output(check_point, 'bracket(s)')
# To indentify missing or unexpected square bracket(s)
check_point = inspector.checker(inspect_parameter[2].first, inspect_parameter[2].last)
